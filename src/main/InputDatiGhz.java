...
public class InputDatiGhz
{
	...
	private static final String ERRORE_VALORE_INVALIDO = "Valore invalido";
	...
	{
		boolean finito = false;
		boolean valoreNonPresenteInBlackList;
		int valoreLetto = 0;
		do
		{
			valoreNonPresenteInBlackList = true;
			valoreLetto = leggiIntero(messaggio);
			if (valoreLetto >= minimo && valoreLetto<= massimo) {
			...
			finito = valoreNonPresenteInBlackList;
			}else {
				if (valoreLetto < minimo)
					System.out.println(ERRORE_MINIMO + minimo);
				else
